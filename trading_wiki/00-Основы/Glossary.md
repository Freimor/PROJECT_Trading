...
> Краткий вход в терминологию. **Полный справочник (~150+ терминов):** [[Financial_glossary]].

## Главное

- **Все термины** — в [[Financial_glossary]] (отдельный файл, поиск Ctrl+F).
- Здесь — только стартовый набор и примеры использования.
...
Ищите термин по алфавиту в таблицах ниже. Переходите по ссылкам `[[...]]` к полным статьям. Начните с [[Finance_basics]] → [[What_is_trading]] → [[Order_types]].
...
На биржах и в API — английские термины. В брокерском приложении — русские. Смысл один.

SEC и FINRA публикуют официальные глоссарии. Этот справочник упрощает их для новичков, но не заменяет первоисточник.
...
| # | Факт | Источник |
|---|------|----------|
| 1 | Stock (акция) — доля владения (equity) в корпорации; право на активы, прибыль и обычно голос. | [Investor.gov: Stock](https://www.investor.gov/introduction-investing/investing-basics/glossary/stock) |
| 2 | Bond (облигация) — долговая бумага: эмитент занимает деньги, платит проценты и возвращает номинал. | [Investor.gov: Bonds FAQs](https://www.investor.gov/introduction-investing/investing-basics/investment-products/bonds-or-fixed-income-products/bonds) |
| 3 | Stop order — активируется при stop price, становится market order; цена исполнения может отличаться. | [Investor.gov: Stop Order](https://www.investor.gov/introduction-investing/investing-basics/glossary/stop-order) |
| 4 | Limit order — купить/продать по конкретной цене или лучше; исполнение не гарантировано. | [SEC: Limit Orders](https://www.sec.gov/answers/limit.htm) |
| 5 | FINRA: equity securities = акции; debt securities = облигации (займ под проценты). | [FINRA: Investing Basics](https://www.finra.org/investors/investing/investing-basics) |
| 6 | Asset allocation — распределение между акциями, облигациями и cash с учётом риска и горизонта. | [Investor.gov: Introduction](https://www.investor.gov/introduction-investing) |
...
| 8 | IPO — первичное публичное размещение акций широкой публике. | [Investor.gov Glossary](https://www.investor.gov/additional-resources/general-resources/glossary) |
| 9 | MOEX — Московская биржа; основная сессия акций (ТП): 10:00–18:54:59 МСК. | [MOEX: Расписание](https://www.moex.com/s1167) |
| 10 | Investor.gov Glossary — сотни терминов, официальный справочник SEC. | [Investor.gov Glossary](https://www.investor.gov/additional-resources/general-resources/glossary) |
...
|-----------|----------------|--------------------------------|--------|
| ВШЭ | Financial Economics WP (2021–2025) | Академическая терминология asset pricing, факторы, микроструктура | [wp.hse.ru/en/prepfr_FE](https://wp.hse.ru/en/prepfr_FE) |
| MIT | 15.481X Adaptive Markets (Fall 2022) | Ключевые понятия EMH, AMH, behavioral finance | [ocw.mit.edu/courses/15-481x-adaptive-markets-fi...](https://ocw.mit.edu/courses/15-481x-adaptive-markets-financial-market-dynamics-and-human-behavior-fall-2022/) |
| Stanford GSB | FINANCE 201 — Investment Valuation | Формальные определения equity, debt, risk/return | [bulletin.stanford.edu/courses/2090781](https://bulletin.stanford.edu/courses/2090781) |
| ВШЭ | Журнал Corporate Finance Research (ВШЭ) | Термины российского рынка: облигации, ESG, хеджирование | [cfjournal.hse.ru/](https://cfjournal.hse.ru/) |
...
- [[Financial_glossary]] — **полный** финансовый глоссарий
- [[Finance_basics]]
- [[What_is_trading]]
- [[Order_types]]
- [[Wiki_structure]]
