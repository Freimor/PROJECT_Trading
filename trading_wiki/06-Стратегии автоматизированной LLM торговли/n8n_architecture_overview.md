...
|---|---|---|---|
| FINSABER (2025) | arXiv:2505.07078 | LLM alpha исчезает при bias-free backtest | https://arxiv.org/abs/2505.07078 |
| TradingAgents (2025) | arXiv:2412.20138 | Multi-agent LLM framework (Ollama-ready) | https://arxiv.org/abs/2412.20138 |
| DeepFund (2025) | arXiv:2505.11065 | Live-бенчмарк LLM-фондов | https://arxiv.org/abs/2505.11065 |
| Lopez-Lira (2025) | BoF PDF | LLM-агенты: коррелированная нестабильность | https://www.suomenpankki.fi/globalassets/bof/en/financial-stability/events/can-large-language-models-trade-ai-agents-competing-in-stock-markets_alejandro-lopez-lira.pdf |
| MIT / A. Lo (2022) | 15.481x | LLM не исполняет ордера напрямую | https://ocw.mit.edu/courses/15-481x-adaptive-markets-financial-market-dynamics-and-human-behavior-fall-2022/ |
